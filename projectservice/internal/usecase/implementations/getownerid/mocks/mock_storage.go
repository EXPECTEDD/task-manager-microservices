...
//
//	mockgen -source=./../../../repository/storage/storagerepo.go -destination=./mocks/mock_storage.go -package=getowneridmocks
//

// Package getowneridmocks is a generated GoMock package.
package getowneridmocks
